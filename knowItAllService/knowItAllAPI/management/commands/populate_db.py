...
class Command(BaseCommand):
    ...
    def createTopics(self):
        ...
        self.createTopic("EE 109", "1", "ee,hell,hard_classes")
        self.createTopic("CSCI 103", "1", "cs,classes,easy_classes")
        self.createTopic("CSCI 109", "1", "cs,classes")
        self.createTopic("CSCI 104", "1", "cs,classes")
        self.createTopic("CSCI 170", "1", "cs,class")
        self.createTopic("CSCI 201", "1", "cs,alright_classes")
        self.createTopic("CSCI 270", "1", "cs,hard_classes")
        self.createTopic("CSCI 310", "1", "cs,cool_classes")
        self.createTopic("CSCI 356", "1", "cs,hard_classes")
        self.createTopic("CSCI 360", "1", "cs,cool_classes")
        ...
        self.createTopic("Blaze Pizza", "2", "food,pizza,tasty,fat_food")
        self.createTopic("Panda Express", "2", "food,americanized_asian_food,fast_food")
        self.createTopic("CAVA", "2", "fast_food,white_people")
        self.createTopic("The Habit Burger and Grill", "2", "burgers,fat_food")
        self.createTopic("Chipotle", "2", "food,americanized_mexican_food")
        self.createTopic("EVK", "2", "food,dining_hall")
        self.createTopic("Cafe 84", "2", "food,dining_hall,rip")
        self.createTopic("Parkside Dining Hall", "2", "food,dining_hall,10000_miles_away")
        ...
        self.createTopic("Wonder Woman", "3", "movies,pretty_woman,superhero")
        self.createTopic("USC Football", "3", "pac12,football,college_football")
        ...
        self.createTopic("Lyon Center", "4", "gym,recreation_center")
        self.createTopic("Village Gym", "4", "gym,cool_gym,new_gym,village")
        self.createTopic("SAL", "4", "cs_majors_lost_souls,office_hours")
